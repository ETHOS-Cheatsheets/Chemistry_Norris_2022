...
\subsection{2.1 Quantenmechanik}{
    ...
    \vspace{1mm}\\
    Innerhalb einer Periode nimmt effektive Kernladung von links nach rechts zu. Daraus folgt, dass  Valenzelektronen stärker an den Kern gebunden sind, der Atomradius nimmt ab. 
}
...
\subsection{4.2 Molekül-Orbital-Modell}{
    ...
    \begin{minipage}{35mm}
        \includegraphics[width=3.5cm]{Bilder/Molekülorbitalmodell.png}
    \end{minipage}
    \begin{minipage}{32mm}
